...
public class Posting extends AbstractPosting {
    ...
    public void writeObject(ObjectOutputStream out) {
        try{
            ...
            for (Integer item : this.positions) out.writeObject(item);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
